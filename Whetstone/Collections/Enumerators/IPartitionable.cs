...
{
    /// <summary>
    /// Trait interface for a <see cref="SC.IEnumerator"/> that can be partitioned for parallel
    /// enumeration.
    /// </summary>
    [PublicAPI]
    ...
    {
        /// <summary>
        /// Try to partition this <see cref="IPartitionable"/> enumerator into two of approximately
        /// equal workload.
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <returns>
        /// A new <see cref="IPartitionable"/> that contains the second partition; or
        /// <see langword="null"/> if partitioning failed / was not feasible.
        /// </returns>

...
namespace Whetstone.Collections.Enumerators
{
        ...
        IDisposable
    {
        ...
        /// <remarks>
        /// <para>
        /// The value of this property needs to follow the precision requirements specified by
        /// <see cref="LengthType"/>. Fetching this value will cause the enumerator to bind.
        /// </para>
        /// <para>
        ...
        int Remaining { [Pure] [BindsEnumerator] get; }

...
{
    /// <summary>
    /// Trait interface for a <see cref="IIndexed{TIndex}"/> enumerator that can jump to a
    /// specified index.
    /// </summary>
    /// <typeparam name="TIndex">The type of the index.</typeparam>
    [PublicAPI]
    public interface IRandomAccess<TIndex> :
        IIndexed<TIndex>
    {
        /// <summary>
        ...
        /// <paramref name="value"/> is outside the enumerator's bounds.
        /// </exception>
        /// <exception cref="InvalidOperationException">The enumerator is disposed.</exception>
        [NotNull]
        new TIndex Index { [Pure] [BindsEnumerator] get; set; }
    }
}
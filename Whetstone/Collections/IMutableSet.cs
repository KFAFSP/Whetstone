...
namespace Whetstone.Collections
{
    ...
    /// </summary>
    [PublicAPI]
    public interface IMutableSet : ISet, IMutableCollection
    {
        /// <summary>
        /// Try to add an item to the set.
        /// </summary>
        /// <param name="AItem">The item to add.</param>
        /// <returns><c>true</c> if <paramref name="AItem"/> was added to the set; <c>false</c> if it already exists.</returns>
        ...
        /// <returns><c>true</c> if <paramref name="AItem"/> was removed from the set; <c>false</c> if it isn't part of the set.</returns>
